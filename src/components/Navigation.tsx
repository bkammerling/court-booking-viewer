    ...
    <nav className="bg-white dark:bg-gray-900 border-b border-b-gray-800 dark:text-white p-4">
      <div className="container mx-auto">
        <div className="flex justify-between items-center">
          <div className="flex items-center logo z-10">
            <Link href="/" className="flex items-center z">
          ...
          <button
            ...
            className="sm:hidden text-gray-500 dark:text-gray-300 focus:outline-none z-10 cursor-pointer"
          >
            {menuOpen ? ( 
              <svg
          ...
          {/* Desktop Menu */}
          <div className={`${menuOpen ? 'flex flex-col justify-center gap-4 text-center h-full w-full fixed top-0 left-0' : 'hidden'} sm:flex sm:flex-row sm:static sm:space-x-2 sm:gap-2 sm:w-auto mt-4 sm:mt-0 bg-white items-center`}>
            <Link 
              href="/search" 
